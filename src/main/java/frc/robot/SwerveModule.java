...
public class SwerveModule {
    ...
    public SwerveModuleState runSetpoint(SwerveModuleState state) {
        ...
        optimizedState.optimize(Rotation2d.fromRotations(mAngleMotor.getPosition().getValueAsDouble()));
